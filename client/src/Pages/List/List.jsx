...
const filt = data?.data?.find(val => val.name === location.state.hotel);
      ...
      <div className="list-container">
        <div className="list-wrapper">
          ...
          <div className="list-result">
            {loading ? "Loading..." : <>
              {filt &&
                <SearchItem item={filt} key={filt._id} date={date} options={options} destination={destination} />
              }
              {!filt && Array.isArray(data.data) && data.data.map(item => (
